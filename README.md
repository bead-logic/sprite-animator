...
Save: Once cleaned, you can click "Save Sheet" to download the new .png, or "Export GIF" to download an animated .gif.

## 💻 Running Locally

This project is built with React and uses modern hooks. The easiest way to run it locally is using Vite.
...
Replace the contents of src/App.jsx with the SpriteAnimator.jsx code.
